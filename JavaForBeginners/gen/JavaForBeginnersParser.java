...
public class JavaForBeginnersParser extends Parser {
	...
	public static class InverseAtomContext extends Boolean_expressionContext {
		public TerminalNode NOT() { return getToken(JavaForBeginnersParser.NOT, 0); }
		public TerminalNode EXTREME() { return getToken(JavaForBeginnersParser.EXTREME, 0); }
		public Boolean_expressionContext boolean_expression() {
			return getRuleContext(Boolean_expressionContext.class,0);
		}
		public InverseAtomContext(Boolean_expressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).enterInverseAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).exitInverseAtom(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof JavaForBeginnersVisitor ) return ((JavaForBeginnersVisitor<? extends T>)visitor).visitInverseAtom(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BoolOrboolContext extends Boolean_expressionContext {
		public Boolean_expressionContext orLeftExpression;
		public Boolean_expressionContext orRightExpression;
		public TerminalNode OR() { return getToken(JavaForBeginnersParser.OR, 0); }
		...
		public BoolOrboolContext(Boolean_expressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).enterBoolOrbool(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).exitBoolOrbool(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof JavaForBeginnersVisitor ) return ((JavaForBeginnersVisitor<? extends T>)visitor).visitBoolOrbool(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AtomConditionalCheckContext extends Boolean_expressionContext {
		public TerminalNode ABSOLUTE() { return getToken(JavaForBeginnersParser.ABSOLUTE, 0); }
		public Boolean_expressionContext boolean_expression() {
			return getRuleContext(Boolean_expressionContext.class,0);
		}
		public AtomConditionalCheckContext(Boolean_expressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).enterAtomConditionalCheck(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).exitAtomConditionalCheck(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof JavaForBeginnersVisitor ) return ((JavaForBeginnersVisitor<? extends T>)visitor).visitAtomConditionalCheck(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BoolAndBoolContext extends Boolean_expressionContext {
		public Boolean_expressionContext andLeftExpression;
		public Boolean_expressionContext andRightExpression;
		public TerminalNode AND() { return getToken(JavaForBeginnersParser.AND, 0); }
		public List<Boolean_expressionContext> boolean_expression() {
			return getRuleContexts(Boolean_expressionContext.class);
		}
		public Boolean_expressionContext boolean_expression(int i) {
		...
		public BoolAndBoolContext(Boolean_expressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).enterBoolAndBool(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavaForBeginnersListener ) ((JavaForBeginnersListener)listener).exitBoolAndBool(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof JavaForBeginnersVisitor ) return ((JavaForBeginnersVisitor<? extends T>)visitor).visitBoolAndBool(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private Boolean_expressionContext boolean_expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				_localctx = new InverseAtomContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(250);
				match(NOT);
			...
			case 3:
				{
				_localctx = new AtomConditionalCheckContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(253);
				match(ABSOLUTE);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(261);
						((ComparisonExpressionContext)_localctx).rightExpression = boolean_expression(8);
						}
						break;
					case 2:
						{
						...
						setState(264);
						((EqualityExpressionContext)_localctx).rightExpression = boolean_expression(5);
						}
						break;
					case 3:
						{
						_localctx = new BoolOrboolContext(new Boolean_expressionContext(_parentctx, _parentState));
						((BoolOrboolContext)_localctx).orLeftExpression = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_boolean_expression);
						setState(265);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(266);
						match(OR);
						setState(267);
						((BoolOrboolContext)_localctx).orRightExpression = boolean_expression(4);
						}
						break;
					case 4:
						{
						_localctx = new BoolAndBoolContext(new Boolean_expressionContext(_parentctx, _parentState));
						((BoolAndBoolContext)_localctx).andLeftExpression = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_boolean_expression);
						setState(268);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(269);
						match(AND);
						setState(270);
						((BoolAndBoolContext)_localctx).andRightExpression = boolean_expression(3);
						}
						break;
					}
					} 
	...
	public static final String _serializedATN =
		...
		"\3\30\3\30\3\30\3\30\3\30\3\30\3\30\3\30\3\30\7\30\u0112\n\30\f\30\16"+
		"\30\u0115\13\30\3\31\3\31\3\31\5\31\u011a\n\31\3\31\3\31\3\31\3\31\3\31"+
		"\3\31\3\31\5\31\u0123\n\31\3\31\2\4,.\32\2\4\6\b\n\f\16\20\22\24\26\30"+
		"\32\34\36 \"$&(*,.\60\2\t\3\2\17\23\4\2%&++\3\2#$\3\2\'*\3\2,-\3\2\30"+
		"\33\3\2\34\35\2\u0139\2\65\3\2\2\2\4>\3\2\2\2\6O\3\2\2\2\bQ\3\2\2\2\n"+
		"U\3\2\2\2\f[\3\2\2\2\16`\3\2\2\2\20e\3\2\2\2\22i\3\2\2\2\24\u0089\3\2"+
		"\2\2\26\u008b\3\2\2\2\30\u0098\3\2\2\2\32\u009c\3\2\2\2\34\u00a9\3\2\2"+
		"\2\36\u00ac\3\2\2\2 \u00b0\3\2\2\2\"\u00bd\3\2\2\2$\u00c5\3\2\2\2&\u00d4"+
		"\3\2\2\2(\u00df\3\2\2\2*\u00e5\3\2\2\2,\u00e7\3\2\2\2.\u0103\3\2\2\2\60"+
		"\u0122\3\2\2\2\62\64\5$\23\2\63\62\3\2\2\2\64\67\3\2\2\2\65\63\3\2\2\2"+
		"\65\66\3\2\2\2\668\3\2\2\2\67\65\3\2\2\289\5\4\3\29:\7\2\2\3:\3\3\2\2"+
		"\2;=\5\6\4\2<;\3\2\2\2=@\3\2\2\2><\3\2\2\2>?\3\2\2\2?\5\3\2\2\2@>\3\2"+
		"\2\2AP\5\22\n\2BP\5\b\5\2CP\5\24\13\2DP\5\26\f\2EP\5\32\16\2FP\5\30\r"+
		"\2GP\5\"\22\2HP\5\n\6\2IP\5\f\7\2JP\5\16\b\2KP\5\20\t\2LM\5,\27\2MN\7"+
